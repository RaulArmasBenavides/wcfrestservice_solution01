using SimpleRESTServiceCRUD.Business;
using System;
...
namespace SimpleRESTServiceCRUD
{
    public class BookService : IBookService
    {
        ...
        public string AddBook2(Book book, string id)
        {
            Book newBook = repository.AddNewBook(book);
            return "id=" + newBook.BookId;
        }

        public void PublishPUBT(Book book, string id)
        {
            BoService _boService = new BoService();
            _boService.MoveDirectory();
        }
    }
}
